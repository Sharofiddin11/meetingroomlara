<html>
    <head>
    	...
    	<link type="text/css" rel="stylesheet" href="<?php echo e(asset('assets/media/layout.css')); ?>" />


	    <script src="<?php echo e(asset('assets/js/jquery/jquery-1.9.1.min.js')); ?>" type="text/javascript"></script>


        <script src="<?php echo e(asset('assets/js/daypilot/daypilot-all.min.js')); ?>" type="text/javascript"></script>

        <link type="text/css" rel="stylesheet" href="<?php echo e(asset('assets/icons/style.css')); ?>" />
                ...
                <div style="margin-left: 20px;">
                    ...
                    <div class="toolbar">
                     ...
                     <div style = "position: absolute; left: 190vh; top: 80px;" >
						<a href="<?php echo e(asset('assets/enter.php')); ?>">Admin</a>
					</div>
                    <div id="dp"></div>
...
//
                    ...
                    $("#add-room").click(function(ev) {
                        ...
                        modal.showUrl("/assets/room_new.php");
                    });
//					
                ...
                <script>
                    ...
                    dp.onTimeRangeSelected = function (args) {
                        ...
                        modal.showUrl("/assets/reservation_new.php?start=" + args.start + "&end=" + args.end + "&resource=" + args.resource);
                    ...
                    dp.onEventClick = function(args) {
                        ...
                        modal.showUrl("/assets/reservation_edit.php?id=" + args.e.id());
                    };
                     ...
                     ///   alert(now.getDatePart());
                        if(end < now) {
                            ...
                            ///    alert(((now.getTimePart() / 1000) % 3600) / 60);
                                ...
                                args.e.toolTip = 'будет занято через  ' + Math.trunc((((start.getTimePart() - now.getTimePart()) / 1000) % 3600) / 60) + ' минут';
                            }
                            else {
                                if(start < now) {
                                    args.e.barColor = 'red';
                                    args.e.toolTip = 'сейчас занято';
                                } else {
                    ...
                    function loadEvents() {
                        ...
                        $.post("/assets/backend_events.php",
                            {
